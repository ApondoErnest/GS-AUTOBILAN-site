...
**Step S004** · Collect from the company before/during build. Files → `brand/` or `design/`.

Company facts: [00-company-data.md](00-company-data.md)
...
Domain · Google Business · social URLs — as available.

Do not treat launch complete until: official tariffs · email confirmed · logo or accepted lockup · FR+EN reviewed · staff soft-launch check.

---

## Related

[01-project-brief.md](01-project-brief.md) · [02-scope.md](02-scope.md) · [../../brand/](../../brand/)
