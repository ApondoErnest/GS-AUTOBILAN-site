...
- Direction Générale: Bastos, derrière Hôtel Le Diplomate; `BP 12525`; `+237 653 283 107`; `gsautosbilan@gmail.com`.
...
```text
Tests: 4 passed (104 assertions)
```

## Acceptance

- Public translations no longer contain stale agency/head-office emails or old Direction Générale phone numbers.
- Public contact page renders confirmed phones, addresses, hours, BP, email, and slogan in FR/EN.
